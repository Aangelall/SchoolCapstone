...
@section('content')
        ...
        <div class="container">
            <div class="main-card">
                ...
                <div class="section-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('section.subject') }}">Sections & Subjects</a>
                                </li>
                ...
                <div class="form-container">
                    <form id="add-class-form" action="{{ route('store.junior.class') }}" method="POST"
                        ...
                        <div class="form-section" id="student-list-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload-container">
                                    <input type="file" id="student-list" name="student_list" accept=".csv"
                                ...
                                <small class="text-muted">CSV format: First Name, Last Name, LRN, Birthday
                                    (YYYY-MM-DD)</small>
                            </div>
                        </div>
    ...
    <style>
        ...
        #edit-section-btn {
            ...
            align-self: center;
            /* Vertically centers with the header */
        }
